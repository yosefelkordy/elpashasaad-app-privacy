...
ستساعدك سياسة الخصوصية الخاصة بنا على فهم ماهية المعلومات التي نجمعها في [منصةالباشا التعليمية] ، وكيف تستخدمها [منصةالباشا التعليمية] ، وما الخيارات المتاحة لك. [منصةالباشا التعليمية] بنيت تطبيق [منصةالباشا التعليمية] كتطبيق مجاني. هذه الخدمة مقدمة من [منصة الباشا التعليمية] بدون تكلفة وهي مخصصة للاستخدام كما هي. إذا اخترت استخدام خدمتنا ، فأنت توافق على جمع واستخدام المعلومات المتعلقة بهذه السياسة. تُستخدم المعلومات الشخصية التي نجمعها لتوفير الخدمة وتحسينها. لن نستخدم أو نشارك معلوماتك مع أي شخص باستثناء ما هو موضح في سياسة الخصوصية هذه.
...
Our privacy policy will help you understand what information we collect at [منصةالباشا التعليمية], how  [منصةالباشا التعليمية] uses it, and what choices you have.  [منصةالباشا التعليمية] built the  [منصةالباشا التعليمية] app as a free app. This SERVICE is provided by  [منصة الباشا التعليمية] at no cost and is intended for use as is. If you choose to use our Service, then you agree to the collection and use of information in relation with this policy. The Personal Information that we collect are used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.
